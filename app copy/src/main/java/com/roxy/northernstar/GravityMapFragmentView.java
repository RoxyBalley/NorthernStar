 ...
 */
public class GravityMapFragmentView {
    ...
    public GravityMapFragmentView(AppCompatActivity activity) {
        m_activity = activity;
        /*
    ...
    private void initResultListButton() {
        m_placeDetailButton = (Button) m_activity.findViewById(R.id.submitbtn);
