...
public class OldGeocodeView {
    ...
    public OldGeocodeView(AppCompatActivity activity) {
        m_activity = activity;
        initMapEngine();
        initUIElements();
    }
    ...
    private void initUIElements() {
        ...
        Button geocodeButton = (Button) m_activity.findViewById(R.id.BtnGeocode);
        Button revGeocodeButton = (Button) m_activity.findViewById(R.id.BtnRevGeocode);
...
//                EditText latLoc = (EditText) m_activity.findViewById(R.id.latLocation);
//                EditText longLoc = (EditText) m_activity.findViewById(R.id.longLocation);
                if(locationText.getText()!=null){
                findLocation = locationText.getText().toString();}
               /* if (latLoc.getText() != null & longLoc.getText() != null){
                    latLocation =  Double.parseDouble(latLoc.getText().toString());
                    longLocation = Double.parseDouble(longLoc.getText().toString());
                } else
                    System.out.print("No Location Name or Coordinates Entered.");*/
            }
        });
    ...
    private void triggerGeocodeRequest() {
         ...
         */
        String query = findLocation;//"4350 Still Creek Dr,Burnaby";
    ...
    private void triggerRevGeocodeRequest() {
        ...
        GeoCoordinate coordinate = new GeoCoordinate(latLocation,longLocation);
